...
void testFILErepoWrite() {
    RepoProdusFile repo{"C:\\Users\\razva\\Desktop\\CV si Proiecte\\OOP\\lab10_11_2\\testFile.txt"};
    assert(repo.getAll().empty());
...
void testFILErepoRead() {
    RepoProdusFile repo{"C:\\Users\\razva\\Desktop\\CV si Proiecte\\OOP\\lab10_11_2\\test.txt"};
