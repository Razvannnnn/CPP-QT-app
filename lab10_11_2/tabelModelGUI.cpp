...
void GUIModel::connectSignalsSlots() {
    QObject::connect(btnAddProdus, &QPushButton::clicked, this, &GUIModel::guiAddProdus);
    QObject::connect(btnModifyProdus, &QPushButton::clicked, this, &GUIModel::guiModifyProdus);
    QObject::connect(btnDeleteProdus, &QPushButton::clicked, this, &GUIModel::guiDeleteProdus);
...
void GUIModel::reloadProdusList(vector<Produs> produse) {
    tableProduse->setProduse(produse);
...
void GUIModel::reloadProdusCosList(vector<Produs> produse) {
    this->listaCos->clear();
